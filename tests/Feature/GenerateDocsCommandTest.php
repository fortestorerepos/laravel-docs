...
XML);
    ...
    expect($html)->toContain(
        ...
        ->and($javascript)->toContain(
            ...
            'type-badge-${esc(type || \'type\')}',
            'const list = value => Array.isArray(value) ? value : Object.values(value || {});',
            'laravel-docs-theme',
            'toggleTheme',
            'document.documentElement.dataset.theme',
            'apiSidebarSwitcher',
            'setApiGroupBy(\'requests\')',
            'laravel-docs-api-group-by',
            "state.apiGroupBy === 'requests' ? method : group.name || 'Endpoints'",
            'methodClass(method)',
            'apiCurlCommand',
            'toggleApiTryout',
            'copyApiExample',
            ...
            'databaseConstraintEntries',
            'database-constraints',
            'dbConstraintsPage',
            'filterConstraintRows',
            'constraintRow',
            'Delete Rule',
            'group:null',
            ...
            'print-database-relations-canvas',
            'drawDatabaseDiagram',
            'downloadPdf',
            'printContent',
            'window.print',
        ...
        ->and($css)->toContain(
            ...
            '.flag-public',
            '.flag-private',
            ':root[data-theme=dark] .flag-public',
            '.code-page',
            '.on-page',
            '.column-anchor',
            '.diagram-toolbar',
